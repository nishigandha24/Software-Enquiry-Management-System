...
<div class="container-scroller">
  <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo" href="admin_panel.php"><img src="images/logo.svg" alt="logo"/></a>
      <a class="navbar-brand brand-logo-mini" href="admin_panel.php"><img src="images/logo-mini.svg" alt="logo"/></a>
    </div>
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
      ...
      <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item dropdown d-lg-flex d-none">
          <a href="register.php"><button type="button" class="btn btn-info font-weight-bold">+ Create New</button></a> 
        </li>
             ...
             <form method="post" action="message.php">
               <button class="button button4" name="id" value="<?php echo $id; ?>">
                 <div id="notification-header">
                   <a class="dropdown-item preview-item" onclick="window.location.href='message.php'">
...
<div class="container-fluid page-body-wrapper">
  ...
  <nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <div class="user-profile">
      <div class="user-image">
        <?php echo '<img src="data:img/jpeg;base64,'.base64_encode( $img ).'" height="50" width="50" align="center"/>';?>
      </div>
      <div class="user-name">
       <?php echo $name; ?>     
     </div>
  ...
  <li class="nav-item">
    <a class="nav-link" href="userstats.php">
      <i class="icon-command menu-icon"></i>
      <span class="menu-title">Users Stats</span>
    </a>
  </li>
</ul>
</nav>
